        ...
        <div class="container">
            <div class="row align-items-center">
                            ...
                            <?php foreach ($misionVisionTabs as $tab): ?>
                                <div class="tab-pane fade<?php echo !empty($tab['activa']) ? ' show active' : ''; ?>" id="<?php echo htmlspecialchars($tab['id'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                                    ...
                                    <?php if (!empty($tab['boton']['href'])): ?>
                                        <a href="<?php echo htmlspecialchars($tab['boton']['href'], ENT_QUOTES, 'UTF-8'); ?>" target="<?php echo htmlspecialchars($tab['boton']['target'] ?? '_self', ENT_QUOTES, 'UTF-8'); ?>" title="<?php echo htmlspecialchars($tab['boton']['title'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-outline-primary mt-2"><?php echo htmlspecialchars($tab['boton']['texto'] ?? '', ENT_QUOTES, 'UTF-8'); ?></a>
                                    <?php endif; ?>
                                </div>
                            <?php endforeach; ?>
                        </div>
                ...
                <div class="col-12 col-md-6" data-aos="fade-left">
                    <img src="<?php echo htmlspecialchars($misionVisionImage, ENT_QUOTES, 'UTF-8'); ?>" class="img-fluid rounded-3 shadow-sm" alt="<?php echo htmlspecialchars($misionVisionAlt, ENT_QUOTES, 'UTF-8'); ?>">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row g-3 align-items-center justify-content-center">
                <?php foreach ($sociosItems as $index => $item): ?>
                    <div class="col-6 col-md-3 col-lg-2 text-center" data-aos="zoom-in" data-aos-delay="<?php echo (int) (($index + 1) * 50); ?>"><img class="partner-logo" src="<?php echo htmlspecialchars($item['urlimagen'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars($item['alt'] ?? 'socio', ENT_QUOTES, 'UTF-8'); ?>"></div>
                <?php endforeach; ?>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-3 aff-grid">
                <?php foreach ($afiliacionesItems as $index => $item): ?>
                    <div class="col" data-aos="zoom-in" data-aos-delay="<?php echo (int) (($index + 1) * 50); ?>"><div class="aff-item p-3"><img src="<?php echo htmlspecialchars($item['urlimagen'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" class="img-fluid" alt="<?php echo htmlspecialchars($item['alt'] ?? 'cert', ENT_QUOTES, 'UTF-8'); ?>"></div></div>
                <?php endforeach; ?>
            </div>
        </div>
    </section>
